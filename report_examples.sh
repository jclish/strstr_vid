...
echo ""
echo "🔍 ADVANCED KEYWORD ANALYSIS EXAMPLES"
echo "======================================"
echo ""
echo "📊 Example 1: Keyword clustering analysis"
echo "Command: ./generate_media_report.sh /path/to/media --format text"
echo "Features:"
echo "  • Groups keywords by themes (mining, nature, industrial, etc.)"
echo "  • Shows keyword clusters with occurrence counts"
echo "  • Provides cluster summary statistics"
echo ""

echo "📊 Example 2: Theme detection"
echo "Command: ./generate_media_report.sh /path/to/media --format text"
echo "Features:"
echo "  • Identifies dominant themes in content"
echo "  • Analyzes theme patterns across media files"
echo "  • Shows theme breakdown and primary themes"
echo ""

echo "📊 Example 3: Sentiment analysis"
echo "Command: ./generate_media_report.sh /path/to/media --format text"
echo "Features:"
echo "  • Analyzes emotional tone of content"
echo "  • Categorizes as positive, negative, neutral"
echo "  • Shows sentiment breakdown and overall mood"
echo ""

echo "📊 Example 4: Language detection"
echo "Command: ./generate_media_report.sh /path/to/media --format text"
echo "Features:"
echo "  • Detects primary language of content"
echo "  • Supports English, Spanish, French, German"
echo "  • Shows language breakdown and primary language"
echo ""

echo "📊 Example 5: Keyword frequency heatmap"
echo "Command: ./generate_media_report.sh /path/to/media --format text"
echo "Features:"
echo "  • Visual representation of keyword frequency"
echo "  • ASCII art heatmap showing keyword intensity"
echo "  • Frequency ranges and diversity analysis"
echo ""

echo "🔍 Advanced Keyword Analysis Features:"
echo "======================================"
...
echo "• Content diversity and frequency analysis"
echo ""

echo "💡 Use Cases:"
echo "=============="
echo "• Content strategy: Understand themes and sentiment"
echo "• Localization: Identify language patterns"
echo "• SEO optimization: Analyze keyword frequency"
echo "• Content planning: Identify dominant themes"
echo "• Quality assessment: Evaluate content sentiment"
echo ""

echo "✅ Advanced Keyword Analysis Implementation Complete!"
echo "Version 2.8 - Advanced Keyword Analysis added to generate_media_report.sh" 